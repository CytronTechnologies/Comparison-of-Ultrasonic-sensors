...
//	Project description	: Analog Sensor: Range using Ultrasonic Range Finder: LV-MaxSonar-EZ
...
while (1)
	...
	case 1:			lcd_2ndline();
					...
					while (SW1 == 1)
						...
						adc_value = adc_value/10;	// adc_value devide by 10 to get average result, max vslue adc_value = 2.55/5 *1024 - 1 =  522
						range_an = adc_value/2;	        // max is 254 inch... 522/254 = ~2
						lcd_goto(0x05);			
